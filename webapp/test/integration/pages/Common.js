sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/zoa/com/ZTEST1/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.zoa.com.ZTEST1.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/zoa/com/ZTEST1/localService/mockserver"], function (mockserver) {
